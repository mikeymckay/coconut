...
Router = (function(_super) {
  ...
  Router.prototype.startApp = function() {
    ...
    return Coconut.config.fetch({
      success: function() {
        $("#footer-menu").html("          <center>          <span style='font-size:75%;display:inline-block'>            <span id='district'></span><br/>            <span id='user'></span>          </span>          <a href='#login'>Login</a>          <a href='#logout'>Logout</a>          <a id='manage-button' style='display:none' href='#manage'>Manage</a>          &nbsp;          <a href='#sync/send'>Send data<br/>(last done: <span class='sync-last-time-sent'></span>)</a>          <a href='#sync/get'>Get data<br/>(last done: <span class='sync-last-time-got'></span>)</a>          <span style='font-size:75%;display:inline-block'>Version<br/><span id='version'></span></span>          </center>        ");
