...
QuestionView = (function(_super) {
  ...
  function QuestionView() {
    ...
    this.loadCase = __bind(this.loadCase, this);
                  ...
                  switch (_this.result.get('question')) {
                    ...
                    case "Household":
                      if (!_(malariaCase.questions).contains('Household Members')) {
                        _(_this.result.get("TotalNumberofResidentsintheHousehold") - 1).times(function() {
                          result = new Result({
                      ...
                      if ((_(malariaCase.questions).filter(function(question) {
                        return question === 'Household';
                      })).length !== 1) {
                        return _(_this.result.get("Numberofotherhouseholdswithin50stepsofindexcasehousehold")).times(function() {
